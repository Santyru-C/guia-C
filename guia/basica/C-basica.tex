...
La estructura \hl{switch} es una forma de controlar el flujo de un programa en función del valor de una variable. La sintaxis de un \hl{switch} es la siguiente:
